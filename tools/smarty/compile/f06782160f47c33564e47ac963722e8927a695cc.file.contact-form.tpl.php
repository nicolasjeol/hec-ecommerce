<?php /* Smarty version Smarty-3.0.7, created on 2012-05-18 00:30:22
         compiled from "/Applications/MAMP/htdocs/prestashop-hec/themes/clothetheme/contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7501939754fb57bfe091171-32403814%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f06782160f47c33564e47ac963722e8927a695cc' => 
    array (
      0 => '/Applications/MAMP/htdocs/prestashop-hec/themes/clothetheme/contact-form.tpl',
      1 => 1337177173,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7501939754fb57bfe091171-32403814',
  'function' => 
  array (
  ),
...
<div style=" margin-left : 25px; text-align: justify; font-size: 13px;">
    <div style="float: left; padding-right: 20px;">
        <img class="fourlink" style="width : 300px; height: 245px;" src="<?php echo $_smarty_tpl->getVariable('img_prod_dir')->value;?>
advantages/thomasdesigner.jpg" alt="designer of visibelly" title="designer of visibelly"/>
    ...
    <div>
        <p>Thomas Rath, born in Cologne, has many talents: he is a designer, stylist and presenter. Without ever visiting a
            fashion school, he became one of the most appreciated designers! He started his career as a designer at Jil
            Sander. Later on, he worked as a chief designer at luxury labels such as Windsor, Mulberry, Kathleen Madden,
            Riani or Wolfgang Ley (Escada). Style wise he advises successful stars and models such as Sarah Jessica Parker,
            Claudia Schiffer and Linda Evangelista. In 2010 Thomas Rath undertook the next step and launched his own fashion
            label, which is characterized by individuality and love for details. Since 2011 he is part of the jury at the
            successful TV-Show “Germany’s next topmodel” and delights everyone by his relaxed and optimistic character and
            his cheerfulness. At Visibelly, he and his highly motivated team are happy advise you personally so that you
            will fall in love with the glasses you buy!
        </p>
    </div>
</div>
...
?>
                <?php if ($_smarty_tpl->tpl_vars['contact']->value['id_contact']==$_smarty_tpl->getVariable('customerThread')->value['id_contact']){?>
                    <input type="text" id="contact_name" name="contact_name"
                           value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['contact']->value['name'],'htmlall','UTF-8');?>
" readonly="readonly"/>
                ...
                <p class="text">
                    ...
                    <?php if (!isset($_smarty_tpl->getVariable('customerThread',null,true,false)->value['id_order'])&&isset($_smarty_tpl->getVariable('isLogged',null,true,false)->value)&&$_smarty_tpl->getVariable('isLogged')->value==1){?>
                        ...
                        <input type="text" name="id_order" id="id_order"
                               value="<?php if (isset($_smarty_tpl->getVariable('customerThread',null,true,false)->value['id_order'])&&$_smarty_tpl->getVariable('customerThread')->value['id_order']>0){?><?php echo intval($_smarty_tpl->getVariable('customerThread')->value['id_order']);?>
...
"
        ...
        <p class="textarea">
            ...
            <textarea id="message" name="message" rows="15" cols="20"
                      style="width:340px;height:220px"><?php if (isset($_smarty_tpl->getVariable('message',null,true,false)->value)){?><?php echo stripslashes(smarty_modifier_escape($_smarty_tpl->getVariable('message')->value,'htmlall','UTF-8'));?>
<?php }?></textarea>
        </p>
