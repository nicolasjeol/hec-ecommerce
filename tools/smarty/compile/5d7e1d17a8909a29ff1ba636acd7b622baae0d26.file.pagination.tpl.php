<?php /* Smarty version Smarty-3.0.7, created on 2012-05-08 00:11:12
         compiled from "/Applications/MAMP/htdocs/prestashop-hec/themes/clothetheme/./pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18940285274fa84880bc6359-08823447%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5d7e1d17a8909a29ff1ba636acd7b622baae0d26' => 
    array (
  ...
  'nocache_hash' => '18940285274fa84880bc6359-08823447',
  'function' => 
  array (
  ),
...
<?php if (isset($_smarty_tpl->getVariable('p',null,true,false)->value)&&$_smarty_tpl->getVariable('p')->value){?>
	...
	<?php if ($_smarty_tpl->getVariable('start')->value!=$_smarty_tpl->getVariable('stop')->value){?>
		...
		<?php if ($_smarty_tpl->getVariable('p')->value!=1){?>
			...
			<li><a href="<?php echo $_smarty_tpl->getVariable('link')->value->goPage($_smarty_tpl->getVariable('requestPage')->value,$_smarty_tpl->getVariable('p_previous')->value);?>
" class="button">&laquo;&nbsp;<?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</a></li>
		<?php }else{ ?>
			<li id="pagination_previous" class="disabled"><span class="button">&laquo;&nbsp;<?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</span></li>
		<?php }?>
...
?>
			...
			<?php }else{ ?>
				<li class="nocurrent"><a href="<?php echo $_smarty_tpl->getVariable('link')->value->goPage($_smarty_tpl->getVariable('requestPage')->value,$_smarty_tpl->getVariable('smarty')->value['section']['pagination']['index']);?>
...
" class="button"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
&nbsp;&raquo;</a></li>
		<?php }else{ ?>
