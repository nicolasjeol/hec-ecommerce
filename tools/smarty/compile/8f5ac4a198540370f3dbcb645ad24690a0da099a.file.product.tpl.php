...
<?php /*%%SmartyHeaderCode:20121897164fa848873050b0-01343971%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '20121897164fa848873050b0-01343971',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_function_math')) include '/Applications/MAMP/htdocs/prestashop-hec/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/Applications/MAMP/htdocs/prestashop-hec/tools/smarty/plugins/function.counter.php';
?>
					...
					<?php if ($_smarty_tpl->getVariable('priceDisplay')->value>=0&&$_smarty_tpl->getVariable('priceDisplay')->value<=2){?>
						<span id="our_price_display"><?php echo Product::convertPrice(array('price'=>$_smarty_tpl->getVariable('productPrice')->value),$_smarty_tpl);?>
							...
							<?php if ($_smarty_tpl->getVariable('tax_enabled')->value&&$_smarty_tpl->getVariable('display_tax_label')->value==1){?>
								<span class="taxo"><?php if ($_smarty_tpl->getVariable('priceDisplay')->value==1){?><?php echo smartyTranslate(array('s'=>'tax excl.'),$_smarty_tpl);?>
...
<?php }?>
			...
			<?php if ((($_smarty_tpl->getVariable('display_qties')->value==1||$_smarty_tpl->getVariable('product')->value->quantity<=$_smarty_tpl->getVariable('last_qties')->value)&&!$_smarty_tpl->getVariable('PS_CATALOG_MODE')->value&&$_smarty_tpl->getVariable('product')->value->available_for_order)){?>
...
_small" alt="" />
									<a href="<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['field']->value['id_customization_field'];?>
<?php $_tmp1=ob_get_clean();?><?php echo $_smarty_tpl->getVariable('link')->value->getProductDeletePictureLink($_smarty_tpl->getVariable('product')->value,$_tmp1);?>
