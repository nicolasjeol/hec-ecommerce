...
{if isset($p) AND $p}
	...
	{if $start!=$stop}
		...
		{if $p != 1}
			...
			<li><a href="{$link->goPage($requestPage, $p_previous)}" class="button">&laquo;&nbsp;{l s='Previous'}</a></li>
		{else}
			<li id="pagination_previous" class="disabled"><span class="button">&laquo;&nbsp;{l s='Previous'}</span></li>
		{/if}
		{if $start>3}
		...
		{if $pages_nb > 1 AND $p != $pages_nb}
			...
			<li id="pagination_next"><a href="{$link->goPage($requestPage, $p_next)}" class="button">{l s='Next'}&nbsp;&raquo;</a></li>
		{else}
			<li id="pagination_next" class="disabled"><span class="button">{l s='Next'}&nbsp;&raquo;</span></li>
		{/if}
		</ul>
	{/if}
	{if $nb_products > 10}
