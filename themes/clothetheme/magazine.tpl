...
<div id="container">
    ...
    <div style="float: left; margin-left: 50px;" class="thumbnails yoxview">
        ...
        <a id="magazineMonth" href="{$img_prod_dir}magazine/page1.png"><img
                src="{$img_prod_dir}magazine/thumbnails/page1.png" alt="First"
                title="First page"/></a>
    </div>
    ...
    <div style="margin-left: 335px; width: 250px;" class="thumbnails yoxview">
        ...
        <a id="magazineLastMonth" href="{$img_prod_dir}magazine/page1.png"><img
                src="{$img_prod_dir}magazine/thumbnails/page1.png" alt="First"
                title="First page"/></a>
    </div>
{*    <div style="float: left; margin-left: 50px;" class="thumbnails yoxview">*}
...
{*    </div>*}
    ...
    <div>
        ...
        <div style="display : block; margin : auto; text-align: center; ">
            <br/>
            <img src="{$img_prod_dir}blog/glasses1.png" alt="rayban" title="rayban"/>
            <img style="height: 150px;" src="{$img_prod_dir}blog/blogger1.png" alt="rayban" title="rayban"/>
            <br/>
        </div>
    ...
    <div>
        ...
        <div style="display : block; margin : auto; text-align: center; ">
            <br/>
            <img src="{$img_prod_dir}blog/glasses2.png" alt="rayban" title="rayban"/>
            <img style="height: 150px;" src="{$img_prod_dir}blog/blogger2.png" alt="rayban" title="rayban"/>
            <br/>
        </div>
    ...
    <div>
        ...
        <div style="display : block; margin : auto; text-align: center; ">
            <br/>
            <img src="{$img_prod_dir}blog/glasses3.png" alt="rayban" title="rayban"/>
            <img style="height: 150px;" src="{$img_prod_dir}blog/blogger3.png" alt="rayban" title="rayban"/>
            <br/>
        </div>
