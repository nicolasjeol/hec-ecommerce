...
<div id="container" style="position: absolute; left: 155px; top : 157px; ">
    <div id="example">
        <div id="slides">
            <div class="slides_container">
                <div class="slide">
                    <a href="{$link->getPageLink('category.php?id_category=65')}">
                        ...
                        <img style="width: 950px;" src="{$img_prod_dir}slider/Feel-legendary.gif" alt="Vintage"
                             title="Vintage"/>
                    </a>
                ...
                <div class="slide">
                    <a href="{$link->getPageLink('contact-form.php')}"> <img style="width: 950px;"
                                                                             src="{$img_prod_dir}slider/Become-unique.gif"
                ...
                <div class="slide">
                    <a href="{$link->getPageLink('magazine.php')}"> <img src="{$img_prod_dir}slider/magazine2.png"
                                                                         alt="magazine"/> </a>
                {*						<div class="caption">*}
            ...
            <a href="#" class="prev"><img src="{$base_dir}/slider/img/arrow-prev.png" width="24" height="43"
                                          alt="Arrow Prev"></a>
            <a href="#" class="next"><img src="{$base_dir}/slider/img/arrow-next.png" width="24" height="43"
                                          alt="Arrow Next"></a>
        </div>
    </div>
</div>
...
<a href="product.php?id_product=1495"> <img style="width: 167px; position: absolute; left: 1100px; top : 563px;"
                                            src="{$img_prod_dir}slider/commentary.png" alt="comment customer"
